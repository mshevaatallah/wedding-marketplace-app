...
import cocok1 from "../../../../assets/images/cocok7.jpeg";
import * as SplashScreen from "expo-splash-screen";
import { Context } from "../../../navigation";

const BusanaThree = ({ navigation }) => {
  const { likes, setLikes, setID } = useContext(Context);
  function addTask() {
    const newLikes = {
      id: 7,
      date: new Date().toDateString(),
      toko: "Yamigamoi Dress",
          ...
          >
            ...
            <View style={{ marginHorizontal: 20, marginTop: 25 }}>
              <View>
                ...
                >
                  Wedding Dress Package By Yamigamoi Dress
                </Text>
                <Text
                  style={{
                ...
                >
                  Merupakan Wedding Dress Package By Yamigamoi Dress yang murah
                ...
                >
                  ...
                  Pernikahan" eksklusif dari Yamigamoi Dress. Ini bukan hanya
                  tentang gaun pernikahan, tetapi tentang mengubah impian
                  pernikahan Anda menjadi kenyataan indah dengan sentuhan magis
                  dan elegan dari Yamigamoi. Dengan "Paket Gaun Pernikahan" oleh
                  Yamigamoi Dress, Anda tidak hanya mendapatkan gaun impian,
                  ...
                  perjalanan kecantikan yang luar biasa bersama Yamigamoi Dress.
                </Text>
              </View>
            </View>
          </View>
